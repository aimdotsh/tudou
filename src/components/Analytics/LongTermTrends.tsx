  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-slate-900/80 border border-slate-800/90 rounded-2xl p-5 backdrop-blur shadow-xl">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="font-bold text-slate-100 text-base">12周 训练量与体能评估 (EvoLab 负荷模型)</h3>
              <p className="text-xs text-slate-400">长期负荷 (CTL 体能) · 短期负荷 (ATL 疲劳) · 负荷比 (TSB 竞技状态)</p>
            </div>
          </div>
        ...
        <div className="w-full h-56 relative pt-2">
          <svg className="w-full h-full overflow-visible" viewBox="0 0 600 180" preserveAspectRatio="none">
            ...
            <line x1="0" y1="160" x2="600" y2="160" stroke="#334155" />
        ...
        <div className="bg-slate-900/80 border border-slate-800/90 rounded-2xl p-5 backdrop-blur shadow-xl">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="font-bold text-slate-100 text-base">最大摄氧量 (VO2 Max)</h3>
                <span className="text-xs text-slate-400">12周有氧耐力极限评估</span>
              </div>
            </div>
            <div className="text-right">
              <span className="text-2xl font-black text-purple-400 font-mono">39</span>
              <span className="text-[10px] text-slate-400 block">最大值: 39 · 平均: 39</span>
            </div>
          </div>
        ...
        <div className="bg-slate-900/80 border border-slate-800/90 rounded-2xl p-5 backdrop-blur shadow-xl">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="font-bold text-slate-100 text-base">静息心率 (RHR 晨脉)</h3>
                <span className="text-xs text-slate-400">12周基础心血管健康走势</span>
              </div>
            </div>
            <div className="text-right">
              <span className="text-2xl font-black text-rose-400 font-mono">60</span>
              <span className="text-[10px] text-slate-400 block">最低: 60 · 平均: 63 bpm</span>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        {/* 强度分布 */}
        <div className="md:col-span-2 bg-slate-900/80 border border-slate-800/90 rounded-2xl p-5 backdrop-blur shadow-xl">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              <div className="p-2 rounded-xl bg-teal-500/10 text-teal-400 border border-teal-500/20">
                <Flame className="w-5 h-5" />
              </div>
              <h3 className="font-bold text-slate-100 text-base">24周 负荷-强度分布</h3>
            </div>
            <div className="flex items-center gap-3 text-xs font-medium">
              <span className="flex items-center gap-1 text-slate-400"><span className="w-2 h-2 rounded bg-sky-400" /> 低强度</span>
              <span className="flex items-center gap-1 text-slate-400"><span className="w-2 h-2 rounded bg-teal-400" /> 中强度</span>
              <span className="flex items-center gap-1 text-slate-400"><span className="w-2 h-2 rounded bg-rose-500" /> 高强度</span>
            </div>
          </div>
              ...
              return (
                <div key={idx} className="space-y-1">
                  ...
                  <div className="w-full h-3 bg-slate-800 rounded-full overflow-hidden flex">
                    <div className="bg-sky-400 h-full" style={{ width: `${lowPct}%` }} />
                    <div className="bg-teal-400 h-full" style={{ width: `${medPct}%` }} />
        ...
        <div className="bg-slate-900/80 border border-slate-800/90 rounded-2xl p-5 backdrop-blur shadow-xl flex flex-col justify-between">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-bold text-slate-100 text-base">4周 配速区间分布</h3>
            </div>
              ...
              {paceDist.map((item: any, idx: number) => (
                <div key={idx} className="space-y-1 text-xs">
                  <div className="flex justify-between font-mono text-slate-300">
                    ...
                    <span className="text-slate-400">{item.percent}% ({item.load} TL)</span>
                  </div>
