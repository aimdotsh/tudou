...
export const MAIN_COLOR = 'rgb(255, 69, 0)';
//export const RUN_COLOR = 'rgb(0, 137, 200)'; //rgb(0, 137, 200)
export const RUN_COLOR = 'rgb(255, 69, 0)'; // Red-Orange, high visibility
export const RIDE_COLOR = 'rgb(80, 50, 200)'; // Deep Purple
export const VIRTUAL_RIDE_COLOR = 'rgb(148, 0, 211)'; // Dark Violet
export const HIKE_COLOR = 'rgb(210, 105, 30)'; // Chocolate
export const SWIM_COLOR = 'rgb(255, 165, 0)'; // Orange
export const ROWING_COLOR = 'rgb(75, 0, 130)'; // Indigo
export const ROAD_TRIP_COLOR = 'rgb(139, 69, 19)'; // Saddle Brown
export const FLIGHT_COLOR = 'rgb(0, 0, 0)'; // Black
export const PROVINCE_FILL_COLOR = '#808080'; // Neutral Grey
export const COUNTRY_FILL_COLOR = '#A9A9A9'; // Dark Grey for unvisited
export const VISITED_CITY_FILL_COLOR = '#21B2AA'; // 访问过的城市高亮颜色（青蓝色）
