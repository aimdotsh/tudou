...
class HeatmapDrawer(TracksDrawer):
    ...
    def _get_line_transparencies_and_widths(self, bbox: s2sphere.LatLngRect) -> List[Tuple[float, float]]:
    ...
    def draw(self, dr: svgwrite.Drawing, g: svgwrite.container.Group, size: XY, offset: XY) -> None:
        ...
        for tr in self.poster.tracks:
            ...
            color = self.color(self.poster.length_range, tr.length, has_special)
